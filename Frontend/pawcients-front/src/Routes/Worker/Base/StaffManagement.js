...
export default function StaffManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetchWorkerRegister(
        name,
        surname,
        email,
        phone,
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              ...
                              onClick={(e) => handleDeleteClick(e, worker.id)}
                            >
              ...
              <div className="modal">
                <div className="modal-content">
                  ...
                  >
                    ...
                    <button className="clasic-button" type="submit">
                      Sign up worker
                    </button>
                    <button
                      className="clasic-button"
                      type="button"
